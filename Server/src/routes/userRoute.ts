...
Router.get("/all-message",messageControler.getMessage)
Router.get("/chat/:id",chatControllers.userChats)
Router.get("/get-message",chatControllers.Allchat)
Router.get("/single-message",chatControllers.singleChat)
Router.post("/last-message",messageControler.lastMessage)
