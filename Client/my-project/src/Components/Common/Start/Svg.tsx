...
const Svg = () => {
  return (
    <div>
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 512 640" enable-background="new 0 0 512 512" xmlSpace="preserve"><g><path d="M262.795,104.858c-3.688-3.922-9.875-3.797-13.329-0.125L72.262,281.969l-0.938,0.938   c-1.484,1.547-2.406,3.812-2.406,6.219v181.188c0,13.203,10.734,23.953,23.938,23.953H419.14c13.219,0,23.953-10.75,23.953-23.953   V288.984c0-2.422-0.953-4.703-2.656-6.438L262.795,104.858z M424.874,476.032H87.137V292.906l168.938-169.032l168.798,168.892   V476.032z"/>
        ...
        <text x="0" y="527" fill="#000000" font-size="5px" font-weight="bold" font-family="'Helvetica Neue', Helvetica, Arial-Unicode, Arial, Sans-serif">Created by Gamma Designs</text><text x="0" y="532" fill="#000000" font-size="5px" font-weight="bold" font-family="'Helvetica Neue', Helvetica, Arial-Unicode, Arial, Sans-serif">from the Noun Project</text></svg>
    </div>
  )
}
